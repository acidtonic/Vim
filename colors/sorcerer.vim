...
highlight CtrlPMode1 ctermbg=1
highlight CtrlPMode2 ctermbg=1
highlight CtrlPStats ctermbg=6 ctermfg=7

highlight CtrlPMatch cterm=none ctermbg=237 ctermfg=208
highlight CtrlPTagExtra cterm=none ctermbg=237 ctermfg=208
"highlight CtrlPMatch cterm=none ctermbg=16 ctermfg=60

"highlight CtrlPMatch ctermbg=208 ctermfg=1
